...
const BlogCard = ({ data }: { data: Post }) => {
  const { summary_length,chinese_summary_length, blog_folder } = config.settings;
  ...
  return (
    <div className="bg-body dark:bg-darkmode-body">
      ...
      <p className="mb-6">
        {/*// TODO 暂时按照中文截取，后续加入英文检测，兼容截取方式*/}
        {plainify(data.content!.slice(0, Number(chinese_summary_length)))}
      </p>
      <Link
